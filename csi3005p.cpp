/*
 * csi3005p power supply,  for Louis Rossmann
 *
 * V0.1 - November 20, 2020
 * 
 *
...
void show_help(void) {
	fprintf(stdout,"CSI3005P Power supply display\r\n"
			...
			"\r\n"
			"\tUSB example: csi3005p -p /dev/usbtmc2\r\n"
			"\tSerial example: csi3005p -p /dev/ttyUSB0 -s 9600:8n1\r\n"
			, BUILD_VER
			, BUILD_DATE 
			);
} 
